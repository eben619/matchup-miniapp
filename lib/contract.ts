...
export const MARKET_FACTORY_CONTRACT = {
  address: "0xf212600617f594bae7a4011f068b314f70a7bb72" as const,
  abi: [
    {
      "inputs": [
        {
    ...
    },
    {
      ...
      "outputs": [
        ...
        },
        {
          ...
          "internalType": "struct MarketFactory.MarketStats",
          "name": "stats",
          "type": "tuple"
        }
      ],
...
// Contract function types for better TypeScript support
export type MarketFactoryContract = typeof MARKET_FACTORY_CONTRACT;
...
export const CONTRACT_FUNCTIONS = {
  ...
  GET_MARKETS_BY_CATEGORY: "getMarketsByCategory",
  GET_ACTIVE_MARKETS: "getActiveMarkets",
  GET_TOTAL_MARKETS: "getTotalMarkets",
} as const;

// Contract event names for easy reference
export const CONTRACT_EVENTS = {
  MARKET_CREATED: "MarketCreated",
  MARKET_RESOLVED: "MarketResolved",
  MARKET_STATS_UPDATED: "MarketStatsUpdated",
} as const;